# Iago_Deluxe - Improvements & Enhancement History
...
This document chronicles the evolution of Iago_Deluxe from a monolithic single-file implementation to a professional, modular game application. Version 2.0 represents a complete architectural refactoring while maintaining 100% backward compatibility.
...
2025-11-19 14:30:15,124 - src.Iago - INFO - Iago_Deluxe v2.0 starting
...
2025-11-19 14:30:15,129 - src.Iago - INFO - Settings loaded from config/reversi-settings.json
...
Iago_Deluxe - Classic Iago/Othello Game
